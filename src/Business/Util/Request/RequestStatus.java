...
public class RequestStatus {
    ...
    public static void initalizePickupRequestStatusMap() {
        ...
        pickupRequestStatusList.put(1, "Raised by Broker - Pending with Exchange Manager");
        pickupRequestStatusList.put(2, "Approved by Exchange Manager - Pending with Logistics Manager");
        pickupRequestStatusList.put(3, "Assigned to Management worker - Pending for pick-up with Management worker");
        pickupRequestStatusList.put(4, "Pick up done - Delivery in progress");
        pickupRequestStatusList.put(5, "Delivery done - With Exchange worker");
