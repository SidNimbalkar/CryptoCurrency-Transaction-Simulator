 ...
 * @author indap.n
 */
public class ExchangeOtherRegionsRequestJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form NGExOOtherRegionsRequestJPanel
     */
    public ExchangeOtherRegionsRequestJPanel(JPanel userProcessContainer, CollectionWorkRequest collectionWorkRequest, Organization organization, UserAccount account, Network network, String message) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblHeader.setText("Exchange Manager - Redirect Request");
        ...
        tblShortage.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request Date", "Exchange Name", "Raised By(Manager Name)", "Assign to Employee", "Status"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(92, 92, 92)
                        .addComponent(lblHeader, javax.swing.GroupLayout.PREFERRED_SIZE, 544, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        ExchangeRequestJPanel panel = (ExchangeRequestJPanel) userProcessContainer.getComponent(componentLength - 1);
        panel.populateTable();
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        collectionWorkRequest.setDeliverToExchange(swr.getNgoName());
        ...
        JOptionPane.showMessageDialog(null, "Request sucessfully redirected to another Exchange.", "Information", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void populateRequestDetails() {
        ...
        lblRequestFromVal.setText(collectionWorkRequest.getRaisedByBroker());
        lblRequestDateVal.setText(collectionWorkRequest.getRequestDate() + "");
        lblQuantityVal.setText(collectionWorkRequest.getTotalQuantity() + " $");
