 ...
 * @author mites
 */
public class ManagementWorkerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public ManagementWorkerWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblHeader.setText("Management Worker - Work Area");

        lblSalutation.setText("Welcome:");

        btnPickup.setText("Fetch Requests");
        ...
        btnDelivery.setText("Transfer Requests");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(103, 103, 103)
                        .addComponent(lblHeader, javax.swing.GroupLayout.PREFERRED_SIZE, 474, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(113, 113, 113))
        );
    ...
    private void btnDeliveryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeliveryActionPerformed
        ManagementWorkerDeliveryJPanel managementWorkerDeliveryJPanel = new ManagementWorkerDeliveryJPanel(userProcessContainer, account, enterprise, network);
        userProcessContainer.add("ManagementWorkerDeliveryJPanel", managementWorkerDeliveryJPanel);
    ...
    private void btnPickupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPickupActionPerformed
        ...
        ManagementWorkerPickUpJPanel managementWorkerPickUpJPanel = new ManagementWorkerPickUpJPanel(userProcessContainer, account);
        userProcessContainer.add("ManagementWorkerPickUpJPanel", managementWorkerPickUpJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
