 ...
 * @author indap.n
 */
public class ManagementWorkerDeliveryJPanel extends javax.swing.JPanel {
    ...
    public ManagementWorkerDeliveryJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblHeader.setText("ManagementWorker - Transfer Queue");
        ...
        tblLogisticsWorker.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Existing Address", "Existing Owner", "Quantity", "Transfer Location", "Status"
            }
        ) {
    ...
    private void btnDeliveryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeliveryActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (request.getStatus().equals(RequestStatus.getPickupStatusMessage(4))) {
                ...
                ManagementWorkerDeliveryDetailsJPanel managementWorkerDeliveryDetailsJPanel = new ManagementWorkerDeliveryDetailsJPanel(userProcessContainer, account, enterprise, request, network);
                userProcessContainer.add("ManagementWorkerDeliveryDetailsJPanel", managementWorkerDeliveryDetailsJPanel);
