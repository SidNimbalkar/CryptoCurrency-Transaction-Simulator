...
public class CollectionWorkRequest extends WorkRequest {
    ...
    private String raisedByBroker;
    private String deliverToExchange;
    ...
    public String getRaisedByBroker() {
        return raisedByBroker;
    }

    public void setRaisedByBroker(String raisedByBroker) {
        this.raisedByBroker = raisedByBroker;
    }

    public String getDeliverToExchange() {
        return deliverToExchange;
    }

    public void setDeliverToExchange(String deliverToExchange) {
        this.deliverToExchange = deliverToExchange;
    }
