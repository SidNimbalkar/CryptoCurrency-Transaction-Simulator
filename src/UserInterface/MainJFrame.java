...
import UserInterface.Customer.WalletHomePanel;
...
public class MainJFrame extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        mainPagePanel2 = new javax.swing.JPanel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        leftPane.setBackground(new java.awt.Color(0, 18, 50));
        ...
        mainPagePanel2.setBackground(new java.awt.Color(255, 255, 255));

        javax.swing.GroupLayout mainPagePanel2Layout = new javax.swing.GroupLayout(mainPagePanel2);
        mainPagePanel2.setLayout(mainPagePanel2Layout);
        mainPagePanel2Layout.setHorizontalGroup(
            mainPagePanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 652, Short.MAX_VALUE)
        );
        mainPagePanel2Layout.setVerticalGroup(
            mainPagePanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 561, Short.MAX_VALUE)
        );

        userProcessContainer.add(mainPagePanel2, "card2");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(passwor.contains("u") && usernam.contains("u"))
        {
            txtUserName.setText(null);
            txtPassword.setText(null);
            WalletHomePanel cpanel= new WalletHomePanel(userProcessContainer);
            userProcessContainer.add("ManagePanel",cpanel);
    ...
    private javax.swing.JPanel mainPagePanel2;
            ...
            try {
                ...
                for (Network n : system.getNetworkList()) {
                    for (Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()) {
                        ...
                        if (e.getEnterpriseType().equals(Enterprise.EnterpriseType.Transactions)) {
                            for (Organization o : e.getOrganizationDirectory().getOrganizationList()) {
                                if (o instanceof TransactionsWorkerOrganization) {
                        ...
                        if (e.getEnterpriseType().equals(Enterprise.EnterpriseType.Exchange)) {
                            ExchangeEnterprise enterprise = (ExchangeEnterprise) e;
                            System.out.println("\nExchange name " + enterprise.getName());
