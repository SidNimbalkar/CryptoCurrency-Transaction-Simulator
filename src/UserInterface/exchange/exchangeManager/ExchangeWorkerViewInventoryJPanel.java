...
public class ExchangeWorkerViewInventoryJPanel extends javax.swing.JPanel {
    ...
    public ExchangeWorkerViewInventoryJPanel(JPanel userProcessContainer, Enterprise enterprise, UserAccount account, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblHeader.setText("Exchange Manager - View Stock");
    ...
    private void btnShortageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShortageActionPerformed
        ExchangeManagerRaiseShortageRequestJPanel ngoRequestJPanel = new ExchangeManagerRaiseShortageRequestJPanel(userProcessContainer, account, enterprise, network);
        userProcessContainer.add("ExRequestJPanel", ngoRequestJPanel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
