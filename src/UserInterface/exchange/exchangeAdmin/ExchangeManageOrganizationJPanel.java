 ...
 * @author vighnesh
 */
public class ExchangeManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    public ExchangeManageOrganizationJPanel(JPanel userProcessContainer, OrganizationDirectory organizationDirectory) {
        initComponents();
    ...
    private void populateCombo() {
        ...
        for (Organization.Type type : Organization.Type.values()) {
            if ((!type.getValue().equals(Organization.Type.ExchangeAdmin.getValue())) && (type.getValue().indexOf("Exchange") >= 0)) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Exchange Admin Work Area - Manage Organization");
