 ...
 * @author indap.n
 */
public class ManagementWorkerDeliveryDetailsJPanel extends javax.swing.JPanel {
    ...
    public ManagementWorkerDeliveryDetailsJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, CollectionWorkRequest request, Network network) {
        initComponents();
    ...
    public void populateDetails() {
        lblRequestedByValue.setText(request.getRaisedBy().getEmployee().getName() + " - " + request.getRaisedByBroker());
    ...
    private void initComponents() {
        ...
        lblHeader.setText("Management Worker - Confirm Transfer");

        lblCost.setText("Transfer Fees:");
        ...
        pnlDeliveryDetails.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        // Assign to Ex Worker's queue who was assigned for pickup
        for (Enterprise e : network.getEnterpriseDirectory().getEnterpriseList()) {
            for (Organization o : e.getOrganizationDirectory().getOrganizationList()) {
                if (o instanceof ExchangeWorkerOrganization) {
    ...
    private void txtCostKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCostKeyPressed
       int key=evt.getKeyCode();
        if ((key >= evt.VK_0 && key <= evt.VK_9)||(key >= evt.VK_NUMPAD0 && key <= evt.VK_NUMPAD9))
        {
            ...
            txtCost.setBackground(Color.YELLOW);
        }
        else
        {
